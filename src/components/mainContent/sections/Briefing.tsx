...
function Briefing() {
  return (
    <section className={style.briefing}>
      <div className={style.briefing__avatar}>
        <img className={style.briefing__avatar__img} src={avatar} alt="Avatar"/>
      </div>
      <div className={style.briefing__container__textContainer}>
